"""
Django settings for magicstore project.
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            "hosts": [("redis://" + os.getenv('REDIS_NAME') + ":" + os.getenv('REDIS_PASS') + "@" + os.getenv('REDIS_CONTAINER') + ":" + os.getenv('REDIS_PORT'))],
        },
    },
}
